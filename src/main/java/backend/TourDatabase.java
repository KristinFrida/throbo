...
public class TourDatabase {
    ...
    static {
        tours.add(new Tour("Northern Lights",
                "/images/tour1.png", "/images/tour1-2.png", "/images/tour1-3.png",
                ...
                4500, generateFixedWeekdays(List.of(DayOfWeek.MONDAY, DayOfWeek.TUESDAY, DayOfWeek.FRIDAY))));

        tours.add(new Tour("Whale Watching",
                "/images/tour2.png", "/images/tour2-2.png", "/images/tour2-3.png",
                ...
                7500, generateFixedWeekdays(List.of(DayOfWeek.MONDAY, DayOfWeek.TUESDAY, DayOfWeek.WEDNESDAY))));

        tours.add(new Tour("Blue Lagoon",
                "/images/tour3.png", "/images/tour3-2.png", "/images/tour3-3.png",
                ...
                3000, generateFixedWeekdays(List.of(DayOfWeek.MONDAY, DayOfWeek.TUESDAY, DayOfWeek.WEDNESDAY, DayOfWeek.THURSDAY, DayOfWeek.FRIDAY, DayOfWeek.SATURDAY, DayOfWeek.SUNDAY))));

        tours.add(new Tour("Katla Ice Cave",
                "/images/tour4.png", "/images/tour4-2.png", "/images/tour4-3.png",
                ...
                6000, generateFixedWeekdays(List.of(DayOfWeek.THURSDAY, DayOfWeek.FRIDAY, DayOfWeek.SATURDAY))));

        tours.add(new Tour("South Coast of Iceland",
                "/images/tour5.png", "/images/tour5-2.png", "/images/tour5-3.png",
                ...
                10000, generateFixedWeekdays(List.of(DayOfWeek.TUESDAY, DayOfWeek.WEDNESDAY, DayOfWeek.FRIDAY))));

        tours.add(new Tour("Golden Circle",
                "/images/tour6.png", "/images/tour6-2.png", "/images/tour6-3.png",
                ...
                8000, generateFixedWeekdays(List.of(DayOfWeek.MONDAY, DayOfWeek.TUESDAY, DayOfWeek.WEDNESDAY, DayOfWeek.THURSDAY, DayOfWeek.FRIDAY, DayOfWeek.SATURDAY, DayOfWeek.SUNDAY))));

        tours.add(new Tour("Highland Snowmobiling",
                "/images/tour7.png", "/images/tour7-2.png", "/images/tour7-3.png",
                ...
                17000, generateFixedWeekdays(List.of(DayOfWeek.FRIDAY, DayOfWeek.SATURDAY, DayOfWeek.SUNDAY))));

        tours.add(new Tour("2-Day Buggy Tour",
                "/images/tour8.png", "/images/tour8-2.png", "/images/tour8-3.png",
                ...
                48000, generateFixedWeekdays(List.of(DayOfWeek.MONDAY, DayOfWeek.WEDNESDAY, DayOfWeek.FRIDAY))));

        tours.add(new Tour("Dog Sledding",
                "/images/tour9.png", "/images/tour9-2.png", "/images/tour9-3.png",
                "Glide through the snowy landscapes of Akureyri on a private 3-hour dog sledding adventure, led by a team of energetic huskies.",
                "Akureyri", 3.0, 0,
                ...
                3500, generateFixedWeekdays(List.of(DayOfWeek.MONDAY, DayOfWeek.THURSDAY, DayOfWeek.SATURDAY))));

        tours.add(new Tour("Hiking with Huskies Dogs",
                "/images/tour10.png", "/images/tour10-2.png", "/images/tour10-3.png",
                ...
                2500, generateFixedWeekdays(List.of(DayOfWeek.TUESDAY, DayOfWeek.WEDNESDAY, DayOfWeek.FRIDAY))));

        tours.add(new Tour("Skaftafell Glacier Hiking",
                "/images/tour11.png", "/images/tour11-2.png", "/images/tour11-3.png",
                "Hike across the breathtaking ice formations of Skaftafell Glacier on this guided adventure, perfect for nature and thrill seekers alike.",
                "Skaftafell", 3.0, 8,
                ...
                4000, generateFixedWeekdays(List.of(DayOfWeek.MONDAY, DayOfWeek.TUESDAY, DayOfWeek.THURSDAY))));

        tours.add(new Tour("Jökulsárlón Boat Tour",
                "/images/tour12.png", "/images/tour12-2.png", "/images/tour12-3.png",
                "Sail among towering icebergs on the Jökulsárlón Glacier Lagoon Boat Tour, a stunning journey through Iceland’s most famous glacier lagoon.",
                "Jökulsárlón", 0.58, 0,
                ...
                6000, generateFixedWeekdays(List.of(DayOfWeek.TUESDAY, DayOfWeek.WEDNESDAY, DayOfWeek.THURSDAY, DayOfWeek.SATURDAY, DayOfWeek.SUNDAY))));
    }
